...
public class Link //extends JApplet
{
    ...
    {
        gp.clearRect(0,0,Zelda.standardSize,Zelda.standardSize);
    ...
    public static Graphics draw(int inFacing, Graphics blank)
    {
        ...
        blank.clearRect(0,0,Zelda.standardSize,Zelda.standardSize);
        gr = blank;
        if (inFacing == 0)
        {
            int[] x = {25, 41, 41, 50, 45, 41, 41, 16, 16,  5,  0, 16, 16};
        ...
        //gr.setColor(Color.black);
        //gr.drawRect(0,0,Zelda.standardSize,Zelda.standardSize);
        return gr;
    }
    public static void /* Graphics */ draw(Graphics la, int inFacing)
    {
        la.clearRect(0,0,Zelda.standardSize,Zelda.standardSize);
