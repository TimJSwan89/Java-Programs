...
public class ZeldaScreen extends JApplet {   
int key, x, sx, y, sy, arrowDelay, speed = 7, rightWall = 1200, bottomWall = 1200, screenWidth = 600, screenHeight = 600;
double chanceOfWall = 0, chanceOfBlock = 10, chanceOfGuy = 2; // These are percents
int windowWidth = screenWidth, windowHeight = screenHeight;
int sw, sh;
double Xscale, Yscale, zoom;
boolean upKey, downKey, leftKey, rightKey, plusKey, minusKey, spaceKey, wrap = true;
...
Player link = new Player(0, 0, 50, 50, 0);
public void init() {
...
//        Yscale = (double) windowHeight / screenHeight;
       ...
       for(int i = 0; i < arrows.size(); i++)
           if (arrows.get(i).pushDirection(all, 9, rightWall, bottomWall, wrap) == 0)
